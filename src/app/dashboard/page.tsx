        ...
        <>
            ...
            {user && (
                <div className="navbar bg-gray-800 flex items-center justify-between py-4 px-6">
                    ...
                    <div className="flex gap-2 items-center flex-grow justify-center"> {/* Changed here */}
                        <div className="dropdown dropdown-end">
                            <ul tabIndex={0} className="dropdown-content bg-base-100 rounded-box w-52 shadow-lg flex gap-20">
                                <li>
                                ...
                                <li>
                                    <Link href="/subscribers" className="text-white-500 hover:text-blue-500">
                                        Subscribers
                                    </Link>
                                </li>
                                <li>
                                ...
                                <li>
                                    <Link href="/getfaq" className="text-white-500 hover:text-blue-500">
                                        FAQ
                                    </Link>
                                </li>
                                <li>
