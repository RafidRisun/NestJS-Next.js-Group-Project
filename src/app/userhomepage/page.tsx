...
export default function UserHomePage() {
    ...
    const handleSeePost = (post: any) => {
        ...
        router.push(`http://localhost:4000/post/${postId}`);
    }
                    ...
                    <ul className="space-y-2">
                        ...
                        <li>
                            <Link href="/notification">
                                <p className="text-blue-500 hover:text-blue-700">Notifications</p>
                            </Link>
                        </li>
                        <li>
                            <Link href="/faq">
                                <p className="text-blue-500 hover:text-blue-700">FAQ</p>
                            </Link>
                        </li>
                        <li>
                            <Link href="/wallet">
                        ...
                        <li>
                            <Link href="/subscription">
                                <p className="text-blue-500 hover:text-blue-700">Subscribe</p>
                            </Link>
                        </li>
                    </ul>
                </nav>
